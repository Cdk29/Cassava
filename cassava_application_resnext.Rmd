---
title: "Efficient Net application"
...
```
```{r}
keras_applications<-reticulate::import("keras_applications")
```


```{r}
conv_base<-keras_applications$resnext$ResNeXt50(weights = "imagenet", include_top = FALSE, input_shape = c(448, 448, 3))
```
