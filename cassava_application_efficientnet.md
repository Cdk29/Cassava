...
![](cassava_application_efficientnet_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
![](cassava_application_efficientnet_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
![](cassava_application_efficientnet_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->

``` r
plot(l_rate, type="b", pch=16, xlab="iteration", cex=0.2, ylab="learning rate", col="grey50")
```

![](cassava_application_efficientnet_files/figure-gfm/unnamed-chunk-30-2.png)<!-- -->
...
![](cassava_application_efficientnet_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
