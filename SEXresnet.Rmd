...
```{r}
dataloader <- fastai::ImageDataLoaders_from_df(df=labels, path=path_img, bs=4, seed=6, 
...
```{r}
learnR <- dataloader %>% cnn_learner(fastai::xse_resnet50(), metrics = accuracy,  model_dir="XSEresnet_files/") #prettier
```
